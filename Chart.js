...
window.famePool = [
  ...
  { cond: (d) => (d.maxWinRate || d.winRate) >= 65 && d.games >= 8, i: "🎯", t: "Scharfschütze II", d: ["Operiert mit dem Queue.", "Kein Millimeter Abweichung.", "Das ist ernst.", "Präzise wie ein Laser.", "Heute sitzt’s."], h: "Erreiche eine Winrate von 65% (mind. 8 Spiele)", g: "Scharfschütze", tier: 2 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 70 && d.games >= 12, i: "🎯", t: "Scharfschütze III", d: ["Das ist eine andere Liga.", "Präzision am Limit.", "70%+ ist stark.", "Der Tisch ist im Griff.", "Kunst am Filz."], h: "Erreiche eine Winrate von 70% (mind. 12 Spiele)", g: "Scharfschütze", tier: 3 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 75 && d.games >= 15, i: "🎯", t: "Scharfschütze IV", d: ["Sehr konstante Leistung.", "Du dominierst die Spiele.", "Starke Quote.", "Gegner hat kaum Chancen.", "Sehr gut."], h: "Erreiche eine Winrate von 75% (mind. 15 Spiele)", g: "Scharfschütze", tier: 4 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 80 && d.games >= 20, i: "🎯", t: "Scharfschütze V", d: ["Das ist Elite.", "80% ist eine Ansage.", "Du bist eine Maschine.", "Kaum zu schlagen.", "Absolut top."], h: "Erreiche eine Winrate von 80% (mind. 20 Spiele)", g: "Scharfschütze", tier: 5 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 82 && d.games >= 25, i: "🎯", t: "Scharfschütze VI", d: ["Das ist fast unheimlich.", "Du machst keine Fehler.", "Präzision pur.", "Der Tisch gehört dir.", "Weltklasse."], h: "Erreiche eine Winrate von 82% (mind. 25 Spiele)", g: "Scharfschütze", tier: 6 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 85 && d.games >= 30, i: "🎯", t: "Scharfschütze VII", d: ["Legendäre Präzision.", "Du bist im Gott-Modus.", "Das ist nicht mehr normal.", "Unbesiegbar.", "Perfektion."], h: "Erreiche eine Winrate von 85% (mind. 30 Spiele)", g: "Scharfschütze", tier: 7 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 88 && d.games >= 35, i: "🎯", t: "Scharfschütze VIII", d: ["Du bist die Matrix.", "Du definierst Präzision neu.", "Absolut unglaublich.", "Ein Billard-Gott.", "Jenseits von Gut und Böse."], h: "Erreiche eine Winrate von 88% (mind. 35 Spiele)", g: "Scharfschütze", tier: 8 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 90 && d.games >= 40, i: "🎯", t: "Scharfschütze IX", d: ["90%? Das ist ein Cheat.", "Du bist nicht von dieser Welt.", "Das Spiel ist zu einfach für dich.", "Eine lebende Legende.", "Unfassbar."], h: "Erreiche eine Winrate von 90% (mind. 40 Spiele)", g: "Scharfschütze", tier: 9 },
  { cond: (d) => (d.maxWinRate || d.winRate) >= 92 && d.games >= 50, i: "🎯", t: "Scharfschütze X", d: ["MAX-Tier: Du hast Billard durchgespielt.", "Die Perfektion hat einen Namen.", "Eine Leistung für die Ewigkeit.", "Der unangefochtene Meister.", "Absoluter Wahnsinn."], h: "Erreiche eine Winrate von 92% (mind. 50 Spiele)", g: "Scharfschütze", tier: 10, max: true },
  ...
  { cond: (d) => d.avgKiller >= 6.0 && d.wins >= 8, i: "🧹", t: "Abräumer III", d: ["Das ist eine Rasur.", "Der Gegner sieht nur noch Reste.", "Dominanz pur.", "Metzger deluxe.", "Unfair gut."], h: "Lass im Schnitt mindestens 6,0 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 3 },
  { cond: (d) => d.avgKiller >= 6.2 && d.wins >= 12, i: "🧹", t: "Abräumer IV", d: ["Gegner kommt kaum an den Tisch.", "Du bist eine Maschine.", "Das ist pure Dominanz.", "Eiskalt und effizient.", "Sehr stark."], h: "Lass im Schnitt mindestens 6,2 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 4 },
  { cond: (d) => d.avgKiller >= 6.5 && d.wins >= 18, i: "🧹", t: "Abräumer V", d: ["Das ist schon fast Demütigung.", "Du spielst in einer anderen Liga.", "Der Tisch ist dein Reich.", "Gnadenlos.", "Absolut überlegen."], h: "Lass im Schnitt mindestens 6,5 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 5 },
  { cond: (d) => d.avgKiller >= 6.8 && d.wins >= 25, i: "🧹", t: "Abräumer VI", d: ["Du bist der Albtraum jedes Gegners.", "Deine Effizienz ist legendär.", "Du lässt nichts als Staub zurück.", "Ein wahrer Meister.", "Unaufhaltsam."], h: "Lass im Schnitt mindestens 6,8 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 6 },
  { cond: (d) => d.avgKiller >= 7.0 && d.wins >= 35, i: "🧹", t: "Abräumer VII", d: ["7.0 ist eine magische Grenze.", "Du bist eine Naturgewalt.", "Deine Gegner resignieren.", "Perfektion in jedem Stoß.", "Eine Klasse für sich."], h: "Lass im Schnitt mindestens 7,0 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 7 },
  { cond: (d) => d.avgKiller >= 7.2 && d.wins >= 50, i: "🧹", t: "Abräumer VIII", d: ["Du hast das Abräumen neu definiert.", "Deine Dominanz ist historisch.", "Du bist eine Legende.", "Gegner fürchten deinen Namen.", "Absoluter Wahnsinn."], h: "Lass im Schnitt mindestens 7,2 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 8 },
  { cond: (d) => d.avgKiller >= 7.3 && d.wins >= 70, i: "🧹", t: "Abräumer IX", d: ["Du bist der unangefochtene König.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Billard-Gott.", "Einfach nur wow."], h: "Lass im Schnitt mindestens 7,3 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 9 },
  { cond: (d) => d.avgKiller >= 7.4 && d.wins >= 100, i: "🧹", t: "Abräumer X", d: ["MAX-Tier: Du bist der personifizierte Abriss.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Effizienz.", "Legende."], h: "Lass im Schnitt mindestens 7,4 Kugeln beim Gegner übrig (pro Sieg)", g: "Abräumer", tier: 10, max: true },
  ...
  { cond: (d) => d.blackWinsCount >= 2, i: "🕵️", t: "Schwarzmagier I", d: ["Einmal dunkel, einmal Sieg.", "Schwarz war auf deiner Seite.", "Die Acht arbeitet für dich.", "Timing passt.", "Hauptsache Sieg."], h: "Hol dir mindestens 2 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 1 },
  { cond: (d) => d.blackWinsCount >= 5, i: "🕵️", t: "Schwarzmagier II", d: ["Schwarz kennt deinen Namen.", "Fünf Mal abgegriffen.", "Die Acht ist dein Joker.", "Dunkle Künste aktiv.", "Macht der Acht."], h: "Hol dir mindestens 5 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 2 },
  { cond: (d) => d.blackWinsCount >= 10, i: "🕵️", t: "Schwarzmagier III", d: ["Die Acht ist praktisch im Team.", "Zehn Mal zugeschlagen.", "Schwarzmagie auf Maximum.", "Das ist ein Trend.", "Dunkel, aber effektiv."], h: "Hol dir mindestens 10 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 3 },
  { cond: (d) => d.blackWinsCount >= 18, i: "🕵️", t: "Schwarzmagier IV", d: ["Du hast einen Pakt mit der 8.", "Die Gegner fürchten deine Anwesenheit.", "Du bist der Meister der dunklen Künste.", "Sehr beeindruckend.", "Weiter so."], h: "Hol dir mindestens 18 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 4 },
  { cond: (d) => d.blackWinsCount >= 30, i: "🕵️", t: "Schwarzmagier V", d: ["Die 8 gehorcht dir aufs Wort.", "Du bist eine Legende der Schwarzmagie.", "Deine Gegner sind nur noch Statisten.", "Unheimlich gut.", "Absolut top."], h: "Hol dir mindestens 30 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 5 },
  { cond: (d) => d.blackWinsCount >= 45, i: "🕵️", t: "Schwarzmagier VI", d: ["Du bist der Großmeister der 8.", "Deine Macht ist unermesslich.", "Du bist der personifizierte Albtraum.", "Eine Klasse für sich.", "Weltklasse."], h: "Hol dir mindestens 45 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 6 },
  { cond: (d) => d.blackWinsCount >= 65, i: "🕵️", t: "Schwarzmagier VII", d: ["Du bist eins mit der 8.", "Deine Fähigkeiten sind übernatürlich.", "Du bist eine Gottheit der Schwarzmagie.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h: "Hol dir mindestens 65 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 7 },
  { cond: (d) => d.blackWinsCount >= 90, i: "🕵️", t: "Schwarzmagier VIII", d: ["Du kontrollierst das Schicksal der 8.", "Deine Macht ist absolut.", "Du bist der unangefochtene Herrscher.", "Eine Legende für die Ewigkeit.", "Unfassbar."], h: "Hol dir mindestens 90 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 8 },
  { cond: (d) => d.blackWinsCount >= 120, i: "🕵️", t: "Schwarzmagier IX", d: ["Du bist die 8.", "Deine Existenz ist ein Mysterium.", "Du bist der Anfang und das Ende.", "Ein Gott unter den Spielern.", "Absoluter Wahnsinn."], h: "Hol dir mindestens 120 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 9 },
  { cond: (d) => d.blackWinsCount >= 150, i: "🕵️", t: "Schwarzmagier X", d: ["MAX-Tier: Du bist der Meister aller Klassen.", "Deine Legende wird ewig leben.", "Du hast das Spiel transzendiert.", "Der unsterbliche Schwarzmagier.", "Legende."], h: "Hol dir mindestens 150 Siege durch Schwarz-Fehler", g: "Schwarzmagier", tier: 10, max: true },
  ...
  { cond: (d) => d.winRateDelta20 >= 15 && d.games >= 40, i:"📈", t:"Selbstoptimierer III",d:["Das ist eine neue Version von dir.","Level-Up im Kopf.","Komplett gedreht.","Ein anderes Tier.","Von unten nach oben."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 15%", g:"Selbstoptimierer", tier:3 },
  { cond: (d) => d.winRateDelta20 >= 20 && d.games >= 50, i:"📈", t:"Selbstoptimierer IV", d:["Du hast das Spiel verstanden.", "Dein Lernfortschritt ist enorm.", "Du bist ein Phänomen.", "Stetige Verbesserung.", "Sehr stark."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 20%", g:"Selbstoptimierer", tier:4 },
  { cond: (d) => d.winRateDelta20 >= 25 && d.games >= 60, i:"📈", t:"Selbstoptimierer V", d:["Du bist ein Meister der Anpassung.", "Dein Potenzial ist grenzenlos.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Entwicklung."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 25%", g:"Selbstoptimierer", tier:5 },
  { cond: (d) => d.winRateDelta20 >= 30 && d.games >= 70, i:"📈", t:"Selbstoptimierer VI", d:["Du bist ein Genie.", "Deine Entwicklung ist legendär.", "Du bist der personifizierte Fortschritt.", "Eine Klasse für sich.", "Weltklasse."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 30%", g:"Selbstoptimierer", tier:6 },
  { cond: (d) => d.winRateDelta20 >= 35 && d.games >= 80, i:"📈", t:"Selbstoptimierer VII", d:["Du bist die Evolution des Spiels.", "Deine Lernkurve ist ein Mythos.", "Du bist ein Billard-Gott.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 35%", g:"Selbstoptimierer", tier:7 },
  { cond: (d) => d.winRateDelta20 >= 40 && d.games >= 90, i:"📈", t:"Selbstoptimierer VIII", d:["Du hast die Grenzen des Möglichen gesprengt.", "Deine Entwicklung ist historisch.", "Du bist eine Legende.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 40%", g:"Selbstoptimierer", tier:8 },
  { cond: (d) => d.winRateDelta20 >= 45 && d.games >= 100, i:"📈", t:"Selbstoptimierer IX", d:["Du bist der unangefochtene König der Optimierung.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 45%", g:"Selbstoptimierer", tier:9 },
  { cond: (d) => d.winRateDelta20 >= 50 && d.games >= 120, i:"📈", t:"Selbstoptimierer X", d:["MAX-Tier: Du bist der personifizierte Fortschritt.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Entwicklung.", "Legende."], h:"Verbessere deine Winrate (letzte 20 vs erste 20) um ≥ 50%", g:"Selbstoptimierer", tier:10, max:true },
  ...
  { cond: (d) => d.vsNemesisWins >= 5, i:"🗡️", t:"Nemesis-Breaker III",d:["Jetzt gehörst du nicht mehr unten hin.","Der Endgegner wackelt.","Dominanz im Kopf.","Du hast ihn gelöst.","Angstgegner? War einmal."], h:"Gewinne 5× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:3 },
  { cond: (d) => d.vsNemesisWins >= 8, i:"🗡️", t:"Nemesis-Breaker IV", d:["Du bist der neue Angstgegner.", "Die Machtverhältnisse haben sich verschoben.", "Du hast den Code geknackt.", "Sehr stark.", "Weiter so."], h:"Gewinne 8× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:4 },
  { cond: (d) => d.vsNemesisWins >= 12, i:"🗡️", t:"Nemesis-Breaker V", d:["Du bist der personifizierte Albtraum.", "Dein Gegner hat schlaflose Nächte.", "Du bist eine Legende.", "Absolut beeindruckend.", "Top-Leistung."], h:"Gewinne 12× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:5 },
  { cond: (d) => d.vsNemesisWins >= 18, i:"🗡️", t:"Nemesis-Breaker VI", d:["Du bist der Gott der Rache.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Gewinne 18× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:6 },
  { cond: (d) => d.vsNemesisWins >= 25, i:"🗡️", t:"Nemesis-Breaker VII", d:["Du bist die Nemesis der Nemesis.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Gewinne 25× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:7 },
  { cond: (d) => d.vsNemesisWins >= 35, i:"🗡️", t:"Nemesis-Breaker VIII", d:["Du hast die Grenzen des Möglichen gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Gewinne 35× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:8 },
  { cond: (d) => d.vsNemesisWins >= 50, i:"🗡️", t:"Nemesis-Breaker IX", d:["Du bist der unangefochtene König der Rivalität.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Gewinne 50× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:9 },
  { cond: (d) => d.vsNemesisWins >= 75, i:"🗡️", t:"Nemesis-Breaker X", d:["MAX-Tier: Du bist der personifizierte Albtraum.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Nemesis.", "Legende."], h:"Gewinne 75× gegen deinen Angstgegner", g:"Nemesis-Breaker", tier:10, max:true },
  ...
  { cond: (d) => d.winsVsTopElo >= 5, i:"👑", t:"Riesen-Jäger III",d:["Du jagst Könige.","Oben ist dein Revier.","Elite-Beweis.","Endboss-Schreck.","Legendär."], h:"Schlage den aktuell bestbewerteten Spieler 5×", g:"Riesen-Jäger", tier:3 },
  { cond: (d) => d.winsVsTopElo >= 8, i:"👑", t:"Riesen-Jäger IV", d:["Du bist der Schrecken der Spitze.", "Die Elite zittert vor dir.", "Du bist ein wahrer Champion-Killer.", "Sehr stark.", "Weiter so."], h:"Schlage den aktuell bestbewerteten Spieler 8×", g:"Riesen-Jäger", tier:4 },
  { cond: (d) => d.winsVsTopElo >= 12, i:"👑", t:"Riesen-Jäger V", d:["Du bist der Königsmörder.", "Deine Siege sind legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Schlage den aktuell bestbewerteten Spieler 12×", g:"Riesen-Jäger", tier:5 },
  { cond: (d) => d.winsVsTopElo >= 18, i:"👑", t:"Riesen-Jäger VI", d:["Du bist der Gott der Underdogs.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Schlage den aktuell bestbewerteten Spieler 18×", g:"Riesen-Jäger", tier:6 },
  { cond: (d) => d.winsVsTopElo >= 25, i:"👑", t:"Riesen-Jäger VII", d:["Du bist der Albtraum der Champions.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Schlage den aktuell bestbewerteten Spieler 25×", g:"Riesen-Jäger", tier:7 },
  { cond: (d) => d.winsVsTopElo >= 35, i:"👑", t:"Riesen-Jäger VIII", d:["Du hast die Hierarchie zerstört.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Schlage den aktuell bestbewerteten Spieler 35×", g:"Riesen-Jäger", tier:8 },
  { cond: (d) => d.winsVsTopElo >= 50, i:"👑", t:"Riesen-Jäger IX", d:["Du bist der unangefochtene König der Jäger.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Schlage den aktuell bestbewerteten Spieler 50×", g:"Riesen-Jäger", tier:9 },
  { cond: (d) => d.winsVsTopElo >= 75, i:"👑", t:"Riesen-Jäger X", d:["MAX-Tier: Du bist der personifizierte Albtraum der Elite.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Riesen-Jäger.", "Legende."], h:"Schlage den aktuell bestbewerteten Spieler 75×", g:"Riesen-Jäger", tier:10, max:true },
  ...
  { cond: (d) => d.closeWins >= 15, i:"🍀", t:"Glücksritter III",d:["Du bist das Plot-Armor.","Unsterblich knapp.","Immer irgendwie raus.","Das grenzt an Magie.","Unfair glücklich."], h:"Gewinne 15 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:3 },
  { cond: (d) => d.closeWins >= 25, i:"🍀", t:"Glücksritter IV", d:["Du hast einen Pakt mit dem Glück.", "Deine Comebacks sind legendär.", "Du bist der Meister des Unmöglichen.", "Sehr beeindruckend.", "Weiter so."], h:"Gewinne 25 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:4 },
  { cond: (d) => d.closeWins >= 40, i:"🍀", t:"Glücksritter V", d:["Du bist der personifizierte Glücksbringer.", "Deine Siege sind ein Wunder.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Gewinne 40 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:5 },
  { cond: (d) => d.closeWins >= 60, i:"🍀", t:"Glücksritter VI", d:["Du bist der Gott des Glücks.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Gewinne 60 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:6 },
  { cond: (d) => d.closeWins >= 85, i:"🍀", t:"Glücksritter VII", d:["Du bist das Glück in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Gewinne 85 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:7 },
  { cond: (d) => d.closeWins >= 115, i:"🍀", t:"Glücksritter VIII", d:["Du hast die Grenzen des Glücks gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Gewinne 115 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:8 },
  { cond: (d) => d.closeWins >= 150, i:"🍀", t:"Glücksritter IX", d:["Du bist der unangefochtene König des Glücks.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Gewinne 150 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:9 },
  { cond: (d) => d.closeWins >= 200, i:"🍀", t:"Glücksritter X", d:["MAX-Tier: Du bist der personifizierte Glücksbringer.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss des Glücks.", "Legende."], h:"Gewinne 200 knappe Spiele (Gegner Rest=1)", g:"Glücksritter", tier:10, max:true },
  ...
  { cond: (d) => d.dramaWins >= 10, i:"🎭", t:"Drama-König III",d:["Der Filz ist deine Bühne.","Finale ist Routine.","Du bist das Drehbuch.","Unfassbar nervenstark.","Legendär spannend."], h:"Gewinne 10 Endgame-Dramen", g:"Drama-König", tier:3 },
  { cond: (d) => d.dramaWins >= 18, i:"🎭", t:"Drama-König IV", d:["Du bist der Meister des Theaters.", "Deine Spiele sind Blockbuster.", "Du bist der Regisseur des Tisches.", "Sehr beeindruckend.", "Weiter so."], h:"Gewinne 18 Endgame-Dramen", g:"Drama-König", tier:4 },
  { cond: (d) => d.dramaWins >= 30, i:"🎭", t:"Drama-König V", d:["Du bist der personifizierte Showman.", "Deine Dramen sind legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Gewinne 30 Endgame-Dramen", g:"Drama-König", tier:5 },
  { cond: (d) => d.dramaWins >= 45, i:"🎭", t:"Drama-König VI", d:["Du bist der Gott des Dramas.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Gewinne 45 Endgame-Dramen", g:"Drama-König", tier:6 },
  { cond: (d) => d.dramaWins >= 65, i:"🎭", t:"Drama-König VII", d:["Du bist das Drama in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Gewinne 65 Endgame-Dramen", g:"Drama-König", tier:7 },
  { cond: (d) => d.dramaWins >= 90, i:"🎭", t:"Drama-König VIII", d:["Du hast die Grenzen des Dramas gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Gewinne 90 Endgame-Dramen", g:"Drama-König", tier:8 },
  { cond: (d) => d.dramaWins >= 120, i:"🎭", t:"Drama-König IX", d:["Du bist der unangefochtene König des Dramas.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Gewinne 120 Endgame-Dramen", g:"Drama-König", tier:9 },
  { cond: (d) => d.dramaWins >= 150, i:"🎭", t:"Drama-König X", d:["MAX-Tier: Du bist der personifizierte Gänsehaut-Moment.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss des Dramas.", "Legende."], h:"Gewinne 150 Endgame-Dramen", g:"Drama-König", tier:10, max:true },
  ...
  { cond: (d) => d.maxLoseStreak <= 2 && d.games >= 120,i:"🧘", t:"Zen-Modus III",d:["Tilt existiert nicht.","Du bist Maschine.","Mentale Elite.","Immer gefährlich.","Zen-Legende."], h:"Höchstens 2 Niederlagen am Stück (bei ≥120 Spielen)", g:"Zen-Modus", tier:3 },
  { cond: (d) => d.maxLoseStreak <= 1 && d.games >= 150, i:"🧘", t:"Zen-Modus IV", d:["Du kennst keine Niederlagenserien.", "Dein Geist ist unbesiegbar.", "Du bist der Meister der mentalen Stärke.", "Sehr beeindruckend.", "Weiter so."], h:"Höchstens 1 Niederlage am Stück (bei ≥150 Spielen)", g:"Zen-Modus", tier:4 },
  { cond: (d) => d.maxLoseStreak <= 1 && d.games >= 200, i:"🧘", t:"Zen-Modus V", d:["Du bist der personifizierte Gleichmut.", "Deine Konstanz ist legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Höchstens 1 Niederlage am Stück (bei ≥200 Spielen)", g:"Zen-Modus", tier:5 },
  { cond: (d) => d.maxLoseStreak === 0 && d.games >= 250, i:"🧘", t:"Zen-Modus VI", d:["Du bist der Gott der mentalen Stärke.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Keine Niederlagen am Stück (bei ≥250 Spielen)", g:"Zen-Modus", tier:6 },
  { cond: (d) => d.maxLoseStreak === 0 && d.games >= 300, i:"🧘", t:"Zen-Modus VII", d:["Du bist der Zen-Meister in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Keine Niederlagen am Stück (bei ≥300 Spielen)", g:"Zen-Modus", tier:7 },
  { cond: (d) => d.maxLoseStreak === 0 && d.games >= 350, i:"🧘", t:"Zen-Modus VIII", d:["Du hast die Grenzen der mentalen Stärke gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Keine Niederlagen am Stück (bei ≥350 Spielen)", g:"Zen-Modus", tier:8 },
  { cond: (d) => d.maxLoseStreak === 0 && d.games >= 400, i:"🧘", t:"Zen-Modus IX", d:["Du bist der unangefochtene König der mentalen Stärke.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Keine Niederlagen am Stück (bei ≥400 Spielen)", g:"Zen-Modus", tier:9 },
  { cond: (d) => d.maxLoseStreak === 0 && d.games >= 500, i:"🧘", t:"Zen-Modus X", d:["MAX-Tier: Du bist der personifizierte Zen-Zustand.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der mentalen Stärke.", "Legende."], h:"Keine Niederlagen am Stück (bei ≥500 Spielen)", g:"Zen-Modus", tier:10, max:true },
  ...
  { cond: (d) => d.winRateLast30 >= 60 && d.winRateLast30 <= 75 && d.games >= 80, i:"⚙️", t:"Stabilitäts-Motor III",d:["Keine Schwankungen.","Maschinenlauf.","Pro-Konstanz.","Immer da.","Stabil-Boss."], h:"Letzte 30 Spiele: Winrate zwischen 60–75%", g:"Stabilitäts-Motor", tier:3 },
  { cond: (d) => d.winRateLast30 >= 65 && d.winRateLast30 <= 80 && d.games >= 100, i:"⚙️", t:"Stabilitäts-Motor IV", d:["Du bist ein Fels in der Brandung.", "Deine Konstanz ist beeindruckend.", "Du bist ein Vorbild an Stabilität.", "Sehr stark.", "Weiter so."], h:"Letzte 30 Spiele: Winrate zwischen 65–80%", g:"Stabilitäts-Motor", tier:4 },
  { cond: (d) => d.winRateLast30 >= 70 && d.winRateLast30 <= 85 && d.games >= 120, i:"⚙️", t:"Stabilitäts-Motor V", d:["Du bist der personifizierte Fels.", "Deine Stabilität ist legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Letzte 30 Spiele: Winrate zwischen 70–85%", g:"Stabilitäts-Motor", tier:5 },
  { cond: (d) => d.winRateLast30 >= 75 && d.winRateLast30 <= 90 && d.games >= 150, i:"⚙️", t:"Stabilitäts-Motor VI", d:["Du bist der Gott der Konstanz.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Letzte 30 Spiele: Winrate zwischen 75–90%", g:"Stabilitäts-Motor", tier:6 },
  { cond: (d) => d.winRateLast30 >= 80 && d.winRateLast30 <= 95 && d.games >= 180, i:"⚙️", t:"Stabilitäts-Motor VII", d:["Du bist die Stabilität in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Letzte 30 Spiele: Winrate zwischen 80–95%", g:"Stabilitäts-Motor", tier:7 },
  { cond: (d) => d.winRateLast30 >= 85 && d.winRateLast30 <= 100 && d.games >= 220, i:"⚙️", t:"Stabilitäts-Motor VIII", d:["Du hast die Grenzen der Stabilität gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Letzte 30 Spiele: Winrate zwischen 85–100%", g:"Stabilitäts-Motor", tier:8 },
  { cond: (d) => d.winRateLast30 >= 90 && d.winRateLast30 <= 100 && d.games >= 260, i:"⚙️", t:"Stabilitäts-Motor IX", d:["Du bist der unangefochtene König der Stabilität.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Letzte 30 Spiele: Winrate zwischen 90–100%", g:"Stabilitäts-Motor", tier:9 },
  { cond: (d) => d.winRateLast30 >= 95 && d.winRateLast30 <= 100 && d.games >= 300, i:"⚙️", t:"Stabilitäts-Motor X", d:["MAX-Tier: Du bist der personifizierte Fels in der Brandung.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Stabilität.", "Legende."], h:"Letzte 30 Spiele: Winrate zwischen 95–100%", g:"Stabilitäts-Motor", tier:10, max:true },
  ...
  { cond: (d) => d.avgRestLossLast20 <= 1.8 && d.games >= 50, i: "🧱", t: "Defensiv-Architekt III", d: ["Das ist ein Käfig.", "Gegner erstickt.", "Taktik-Meister.", "Zero-Chancen-Zone.", "Defensiv-Legende."], h: "Letzte 20 Niederlagen: Ø Rest ≤ 1,8", g: "Defensiv-Architekt", tier: 3 },
  { cond: (d) => d.avgRestLossLast20 <= 1.5 && d.games >= 60, i:"🧱", t: "Defensiv-Architekt IV", d:["Du bist eine undurchdringbare Mauer.", "Deine Defensive ist legendär.", "Du bist ein Meister der Kontrolle.", "Sehr beeindruckend.", "Weiter so."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 1,5", g:"Defensiv-Architekt", tier:4 },
  { cond: (d) => d.avgRestLossLast20 <= 1.2 && d.games >= 70, i:"🧱", t: "Defensiv-Architekt V", d:["Du bist der personifizierte Beton.", "Deine Defensive ist eine Kunstform.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 1,2", g:"Defensiv-Architekt", tier:5 },
  { cond: (d) => d.avgRestLossLast20 <= 1.0 && d.games >= 80, i:"🧱", t: "Defensiv-Architekt VI", d:["Du bist der Gott der Defensive.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 1,0", g:"Defensiv-Architekt", tier:6 },
  { cond: (d) => d.avgRestLossLast20 <= 0.8 && d.games >= 90, i:"🧱", t: "Defensiv-Architekt VII", d:["Du bist die Defensive in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 0,8", g:"Defensiv-Architekt", tier:7 },
  { cond: (d) => d.avgRestLossLast20 <= 0.6 && d.games >= 100, i:"🧱", t: "Defensiv-Architekt VIII", d:["Du hast die Grenzen der Defensive gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 0,6", g:"Defensiv-Architekt", tier:8 },
  { cond: (d) => d.avgRestLossLast20 <= 0.4 && d.games >= 120, i:"🧱", t: "Defensiv-Architekt IX", d:["Du bist der unangefochtene König der Defensive.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 0,4", g:"Defensiv-Architekt", tier:9 },
  { cond: (d) => d.avgRestLossLast20 <= 0.2 && d.games >= 150, i:"🧱", t: "Defensiv-Architekt X", d:["MAX-Tier: Du bist die personifizierte Mauer.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Defensive.", "Legende."], h:"Letzte 20 Niederlagen: Ø Rest ≤ 0,2", g:"Defensiv-Architekt", tier:10, max:true },
  ...
  { cond: (d) => d.breakWins >= 25 && d.avgKillerLast20 >= 6.2, i:"🏎️", t:"Tempo-Boss III",d:["Das ist Speedrun.","Du löschst Gegner.","Unfair schnell.","Kein Warmwerden.","Tempo-Legende."], h:"Mind. 25 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 6,2", g:"Tempo-Boss", tier:3 },
  { cond: (d) => d.breakWins >= 40 && d.avgKillerLast20 >= 6.5, i:"🏎️", t:"Tempo-Boss IV", d:["Du bist der König des Tempos.", "Deine Geschwindigkeit ist legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Mind. 40 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 6,5", g:"Tempo-Boss", tier:4 },
  { cond: (d) => d.breakWins >= 60 && d.avgKillerLast20 >= 6.8, i:"🏎️", t:"Tempo-Boss V", d:["Du bist der personifizierte Blitz.", "Deine Schnelligkeit ist eine Waffe.", "Du bist eine Legende.", "Eine Klasse für sich.", "Weltklasse."], h:"Mind. 60 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 6,8", g:"Tempo-Boss", tier:5 },
  { cond: (d) => d.breakWins >= 85 && d.avgKillerLast20 >= 7.0, i:"🏎️", t:"Tempo-Boss VI", d:["Du bist der Gott des Tempos.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Mind. 85 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 7,0", g:"Tempo-Boss", tier:6 },
  { cond: (d) => d.breakWins >= 115 && d.avgKillerLast20 >= 7.2, i:"🏎️", t:"Tempo-Boss VII", d:["Du bist das Tempo in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Mind. 115 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 7,2", g:"Tempo-Boss", tier:7 },
  { cond: (d) => d.breakWins >= 150 && d.avgKillerLast20 >= 7.3, i:"🏎️", t:"Tempo-Boss VIII", d:["Du hast die Grenzen des Tempos gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unsterblich.", "Legende."], h:"Mind. 150 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 7,3", g:"Tempo-Boss", tier:8 },
  { cond: (d) => d.breakWins >= 200 && d.avgKillerLast20 >= 7.4, i:"🏎️", t:"Tempo-Boss IX", d:["Du bist der unangefochtene König des Tempos.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unfassbar."], h:"Mind. 200 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 7,4", g:"Tempo-Boss", tier:9 },
  { cond: (d) => d.breakWins >= 250 && d.avgKillerLast20 >= 7.5, i:"🏎️", t:"Tempo-Boss X", d:["MAX-Tier: Du bist der personifizierte Speedrun.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss des Tempos.", "Legende."], h:"Mind. 250 Siege nach Anstoß + Ø Gegner-Reste/Sieg (letzte 20) ≥ 7,5", g:"Tempo-Boss", tier:10, max:true },
  ...
  { cond: (d) => d.stolenServiceWins >= 3, i: "🕵️", t: "Einbruch-Spezialist I", d: ["Gegner stößt an, er gewinnt.", "Einbruch geglückt.", "Service-Diebstahl."], h: "Gewinne 3 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 1 },
  { cond: (d) => d.stolenServiceWins >= 10, i: "🕵️", t: "Einbruch-Spezialist II", d: ["Klaut Siege wie am Fließband.", "Kein Respekt vor dem Anstoßrecht.", "Profieinbrecher."], h: "Gewinne 10 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 2 },
  { cond: (d) => d.stolenServiceWins >= 25, i: "🕵️", t: "Einbruch-Spezialist III", d: ["Anstoßvorteil? Nicht gegen ihn.", "Ein Albtraum für Break-Spieler.", "Meisterdieb."], h: "Gewinne 25 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 3 },
  { cond: (d) => d.stolenServiceWins >= 45, i: "🕵️", t: "Einbruch-Spezialist IV", d: ["Du bist der König der Diebe.", "Deine Einbrüche sind legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h: "Gewinne 45 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 4 },
  { cond: (d) => d.stolenServiceWins >= 70, i: "🕵️", t: "Einbruch-Spezialist V", d: ["Du bist der personifizierte Albtraum.", "Deine Diebstähle sind eine Kunstform.", "Du bist eine Legende.", "Eine Klasse für sich.", "Weltklasse."], h: "Gewinne 70 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 5 },
  { cond: (d) => d.stolenServiceWins >= 100, i: "🕵️", t: "Einbruch-Spezialist VI", d: ["Du bist der Gott der Einbrüche.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h: "Gewinne 100 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 6 },
  { cond: (d) => d.stolenServiceWins >= 135, i: "🕵️", t: "Einbruch-Spezialist VII", d: ["Du bist der Einbruch in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Unfassbar.", "Absoluter Wahnsinn."], h: "Gewinne 135 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 7 },
  { cond: (d) => d.stolenServiceWins >= 175, i: "🕵️", t: "Einbruch-Spezialist VIII", d: ["Du hast die Grenzen des Diebstahls gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unsterblich.", "Legende."], h: "Gewinne 175 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 8 },
  { cond: (d) => d.stolenServiceWins >= 220, i: "🕵️", t: "Einbruch-Spezialist IX", d: ["Du bist der unangefochtene König der Diebe.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unfassbar."], h: "Gewinne 220 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 9 },
  { cond: (d) => d.stolenServiceWins >= 270, i: "🕵️", t: "Einbruch-Spezialist X", d: ["MAX-Tier: Du bist der personifizierte Meisterdieb.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Einbrüche.", "Legende."], h: "Gewinne 270 Matches, bei denen der Gegner Anstoß hatte", g: "Einbruch-Spezialist", tier: 10, max: true },
  ...
  { cond: (d) => d.completedTracks >= 5, i:"🏁", t:"Track-Master III",d:["Du hast die Tracks im Griff.","Komplettierungs-Boss.","Alles sauber.","Unfair konsequent.","Legendär."], h:"Schließe 5 Achievement-Tracks komplett ab", g:"Track-Master", tier:3 },
  { cond: (d) => d.completedTracks >= 7, i:"🏁", t:"Track-Master IV", d:["Du bist der König der Tracks.", "Deine Sammlung ist beeindruckend.", "Du bist ein Vorbild an Ausdauer.", "Sehr stark.", "Weiter so."], h:"Schließe 7 Achievement-Tracks komplett ab", g:"Track-Master", tier:4 },
  { cond: (d) => d.completedTracks >= 10, i:"🏁", t:"Track-Master V", d:["Du bist der personifizierte Komplettierer.", "Deine Sammlung ist legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Schließe 10 Achievement-Tracks komplett ab", g:"Track-Master", tier:5 },
  { cond: (d) => d.completedTracks >= 13, i:"🏁", t:"Track-Master VI", d:["Du bist der Gott der Tracks.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Schließe 13 Achievement-Tracks komplett ab", g:"Track-Master", tier:6 },
  { cond: (d) => d.completedTracks >= 16, i:"🏁", t:"Track-Master VII", d:["Du bist der Track-Master in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Schließe 16 Achievement-Tracks komplett ab", g:"Track-Master", tier:7 },
  { cond: (d) => d.completedTracks >= 20, i:"🏁", t:"Track-Master VIII", d:["Du hast die Grenzen der Tracks gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Schließe 20 Achievement-Tracks komplett ab", g:"Track-Master", tier:8 },
  { cond: (d) => d.completedTracks >= 24, i:"🏁", t:"Track-Master IX", d:["Du bist der unangefochtene König der Tracks.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Schließe 24 Achievement-Tracks komplett ab", g:"Track-Master", tier:9 },
  { cond: (d) => d.completedTracks >= 28, i:"🏁", t:"Track-Master X", d:["MAX-Tier: Du bist der personifizierte Track-Gott.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Tracks.", "Legende."], h:"Schließe 28 Achievement-Tracks komplett ab", g:"Track-Master", tier:10, max:true },
];
...
window.shamePool = [
  ...
  { cond: (d) => d.winRate <= 35 && d.games >= 8, i: "🤡", t: "Clown II", d: ["Die Manege ist offen.", "Gegner sagen danke.", "Das tut weh.", "Comedy-Abend.", "Reset empfohlen."], h: "Gewinne höchstens 35% deiner Matches (mind. 8 Spiele)", g: "Clown", tier: 2 },
  { cond: (d) => d.winRate <= 30 && d.games >= 12, i: "🤡", t: "Clown III", d: ["Zirkusdirektor in Ausbildung.", "Heute nur Drama.", "Hartes Pflaster.", "Morgen wird besser.", "Aua."], h: "Gewinne höchstens 30% deiner Matches (mind. 12 Spiele)", g: "Clown", tier: 3 },
  { cond: (d) => d.winRate <= 25 && d.games >= 15, i: "🤡", t: "Clown IV", d: ["Du bist der Star der Show.", "Deine Auftritte sind unvergesslich.", "Du bist ein Meister der Komik.", "Sehr unterhaltsam.", "Weiter so."], h: "Gewinne höchstens 25% deiner Matches (mind. 15 Spiele)", g: "Clown", tier: 4 },
  { cond: (d) => d.winRate <= 20 && d.games >= 20, i: "🤡", t: "Clown V", d: ["Du bist der personifizierte Zirkus.", "Deine Shows sind legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Unterhaltung."], h: "Gewinne höchstens 20% deiner Matches (mind. 20 Spiele)", g: "Clown", tier: 5 },
  { cond: (d) => d.winRate <= 18 && d.games >= 25, i: "🤡", t: "Clown VI", d: ["Du bist der Gott des Zirkus.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h: "Gewinne höchstens 18% deiner Matches (mind. 25 Spiele)", g: "Clown", tier: 6 },
  { cond: (d) => d.winRate <= 15 && d.games >= 30, i: "🤡", t: "Clown VII", d: ["Du bist der Zirkus in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h: "Gewinne höchstens 15% deiner Matches (mind. 30 Spiele)", g: "Clown", tier: 7 },
  { cond: (d) => d.winRate <= 12 && d.games >= 35, i: "🤡", t: "Clown VIII", d: ["Du hast die Grenzen des Zirkus gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h: "Gewinne höchstens 12% deiner Matches (mind. 35 Spiele)", g: "Clown", tier: 8 },
  { cond: (d) => d.winRate <= 10 && d.games >= 40, i: "🤡", t: "Clown IX", d: ["Du bist der unangefochtene König des Zirkus.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h: "Gewinne höchstens 10% deiner Matches (mind. 40 Spiele)", g: "Clown", tier: 9 },
  { cond: (d) => d.winRate <= 8 && d.games >= 50, i: "🤡", t: "Clown X", d: ["MAX-Tier: Du bist der personifizierte Zirkusdirektor.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss des Zirkus.", "Legende."], h: "Gewinne höchstens 8% deiner Matches (mind. 50 Spiele)", g: "Clown", tier: 10, max: true },
  ...
  { cond: (d) => d.avgRest >= 6.5 && (d.games - d.wins) >= 4, i: "🧱", t: "Kugelsammler II", d: ["Reste wie Tapete.", "Der Tisch wird nie leer.", "Zu passiv.", "Mehr Mut!", "Das muss sauberer."], h: "Lass im Schnitt 6,5+ Kugeln bei Niederlagen übrig (mind. 4 Niederlagen)", g: "Kugelsammler", tier: 2 },
  { cond: (d) => d.avgRest >= 7.0 && (d.games - d.wins) >= 5, i: "🧱", t: "Kugelsammler III", d: ["Containerdienst rufen.", "Alles bleibt liegen.", "Lagerverwaltung.", "Aua.", "Das ist viel."], h: "Lass im Schnitt 7,0+ Kugeln bei Niederlagen übrig (mind. 5 Niederlagen)", g: "Kugelsammler", tier: 3 },
  { cond: (d) => d.avgRest >= 7.5 && (d.games - d.wins) >= 6, i: "🧱", t: "Kugelsammler IV", d: ["Du bist der König der Reste.", "Deine Sammlung ist beeindruckend.", "Du bist ein Vorbild an Großzügigkeit.", "Sehr großzügig.", "Weiter so."], h: "Lass im Schnitt 7,5+ Kugeln bei Niederlagen übrig (mind. 6 Niederlagen)", g: "Kugelsammler", tier: 4 },
  { cond: (d) => d.avgRest >= 8.0 && (d.games - d.wins) >= 7, i: "🧱", t: "Kugelsammler V", d: ["Du bist der personifizierte Rest.", "Deine Sammlung ist legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Sammlung."], h: "Lass im Schnitt 8,0+ Kugeln bei Niederlagen übrig (mind. 7 Niederlagen)", g: "Kugelsammler", tier: 5 },
  { cond: (d) => d.avgRest >= 8.2 && (d.games - d.wins) >= 8, i: "🧱", t: "Kugelsammler VI", d: ["Du bist der Gott der Reste.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h: "Lass im Schnitt 8,2+ Kugeln bei Niederlagen übrig (mind. 8 Niederlagen)", g: "Kugelsammler", tier: 6 },
  { cond: (d) => d.avgRest >= 8.5 && (d.games - d.wins) >= 10, i: "🧱", t: "Kugelsammler VII", d: ["Du bist der Rest in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h: "Lass im Schnitt 8,5+ Kugeln bei Niederlagen übrig (mind. 10 Niederlagen)", g: "Kugelsammler", tier: 7 },
  { cond: (d) => d.avgRest >= 8.8 && (d.games - d.wins) >= 12, i: "🧱", t: "Kugelsammler VIII", d: ["Du hast die Grenzen der Reste gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h: "Lass im Schnitt 8,8+ Kugeln bei Niederlagen übrig (mind. 12 Niederlagen)", g: "Kugelsammler", tier: 8 },
  { cond: (d) => d.avgRest >= 9.0 && (d.games - d.wins) >= 15, i: "🧱", t: "Kugelsammler IX", d: ["Du bist der unangefochtene König der Reste.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h: "Lass im Schnitt 9,0+ Kugeln bei Niederlagen übrig (mind. 15 Niederlagen)", g: "Kugelsammler", tier: 9 },
  { cond: (d) => d.avgRest >= 9.2 && (d.games - d.wins) >= 20, i: "🧱", t: "Kugelsammler X", d: ["MAX-Tier: Du bist der personifizierte Restesammler.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Reste.", "Legende."], h: "Lass im Schnitt 9,2+ Kugeln bei Niederlagen übrig (mind. 20 Niederlagen)", g: "Kugelsammler", tier: 10, max: true },
  ...
  { cond: (d) => d.clutchWins === 0 && d.games >= 20, i: "🚫", t: "Nervenbündel III", d: ["20 Spiele und kein Krimi-Sieg.", "Das ist eine Serie.", "Crunchtime bleibt leer.", "Aua.", "Kopf hoch."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 20 Spiele)", g: "Nervenbündel", tier: 3 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 30, i: "🚫", t: "Nervenbündel IV", d: ["Du bist der König der vergebenen Chancen.", "Deine Nerven sind aus Pudding.", "Du bist ein Meister des Scheiterns.", "Sehr konsequent.", "Weiter so."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 30 Spiele)", g: "Nervenbündel", tier: 4 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 45, i: "🚫", t: "Nervenbündel V", d: ["Du bist der personifizierte Druckabfall.", "Deine Nerven sind legendär schwach.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 45 Spiele)", g: "Nervenbündel", tier: 5 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 65, i: "🚫", t: "Nervenbündel VI", d: ["Du bist der Gott der Zitterhände.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 65 Spiele)", g: "Nervenbündel", tier: 6 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 90, i: "🚫", t: "Nervenbündel VII", d: ["Du bist das Nervenbündel in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 90 Spiele)", g: "Nervenbündel", tier: 7 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 120, i: "🚫", t: "Nervenbündel VIII", d: ["Du hast die Grenzen der Nervosität gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 120 Spiele)", g: "Nervenbündel", tier: 8 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 155, i: "🚫", t: "Nervenbündel IX", d: ["Du bist der unangefochtene König der Nervenbündel.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 155 Spiele)", g: "Nervenbündel", tier: 9 },
  { cond: (d) => d.clutchWins === 0 && d.games >= 200, i: "🚫", t: "Nervenbündel X", d: ["MAX-Tier: Du bist der personifizierte Nervenzusammenbruch.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Nervenbündel.", "Legende."], h: "Gewinne keinen 1-Kugel-Krimi (mind. 200 Spiele)", g: "Nervenbündel", tier: 10, max: true },
  ...
  { cond: (d) => d.winRateDelta20 <= -5  && d.games >= 40, i:"🌀", t:"Tilt-Spirale I",  d:["Die Kurve kippt.","Irgendwas stimmt nicht.","Form im Keller.","Da geht was verloren.","Atmen. Reset."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 5%",  g:"Tilt-Spirale", tier:1 },
  { cond: (d) => d.winRateDelta20 <= -10 && d.games >= 40, i:"🌀", t:"Tilt-Spirale II", d:["Das tut weh.","Das ist ein Trend.","Kopf raus.","Du rutschst weg.","Stopp die Abfahrt."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 10%", g:"Tilt-Spirale", tier:2 },
  { cond: (d) => d.winRateDelta20 <= -15 && d.games >= 40, i:"🌀", t:"Tilt-Spirale III",d:["Crash-Modus.","Nichts greift.","Der Filz hasst dich.","Das ist bitter.","Trainer rufen."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 15%", g:"Tilt-Spirale", tier:3 },
  { cond: (d) => d.winRateDelta20 <= -20 && d.games >= 50, i:"🌀", t:"Tilt-Spirale IV", d:["Du bist im freien Fall.", "Deine Form ist verschwunden.", "Du bist ein Schatten deiner selbst.", "Sehr besorgniserregend.", "Kopf hoch."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 20%", g:"Tilt-Spirale", tier:4 },
  { cond: (d) => d.winRateDelta20 <= -25 && d.games >= 60, i:"🌀", t:"Tilt-Spirale V", d:["Du bist der personifizierte Absturz.", "Deine Talfahrt ist legendär.", "Du bist eine Warnung.", "Absolut desaströs.", "Hilfe holen."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 25%", g:"Tilt-Spirale", tier:5 },
  { cond: (d) => d.winRateDelta20 <= -30 && d.games >= 70, i:"🌀", t:"Tilt-Spirale VI", d:["Du bist der Gott des Tiltens.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 30%", g:"Tilt-Spirale", tier:6 },
  { cond: (d) => d.winRateDelta20 <= -35 && d.games >= 80, i:"🌀", t:"Tilt-Spirale VII", d:["Du bist der Tilt in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 35%", g:"Tilt-Spirale", tier:7 },
  { cond: (d) => d.winRateDelta20 <= -40 && d.games >= 90, i:"🌀", t:"Tilt-Spirale VIII", d:["Du hast die Grenzen des Tiltens gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 40%", g:"Tilt-Spirale", tier:8 },
  { cond: (d) => d.winRateDelta20 <= -45 && d.games >= 100, i:"🌀", t:"Tilt-Spirale IX", d:["Du bist der unangefochtene König des Tiltens.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 45%", g:"Tilt-Spirale", tier:9 },
  { cond: (d) => d.winRateDelta20 <= -50 && d.games >= 120, i:"🌀", t:"Tilt-Spirale X", d:["MAX-Tier: Du bist der personifizierte Tilt.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss des Tiltens.", "Legende."], h:"Winrate (letzte 20 vs erste 20) fällt um ≥ 50%", g:"Tilt-Spirale", tier:10, max:true },
  ...
  { cond: (d) => d.closeLosses >= 15, i: "🌧️", t: "Tragik-Magnet III",d: ["Du bist der Plot-Twist.", "Finale Kugel? Nein.", "Das ist verflucht.", "Tränen auf Filz.", "Endgame-Opfer."], h: "Verliere 15 knappe Spiele (du Rest=1)", g: "Tragik-Magnet", tier: 3 },
  { cond: (d) => d.closeLosses >= 25, i:"🌧️", t:"Tragik-Magnet IV", d:["Du bist der König der knappen Niederlagen.", "Deine Sammlung ist beeindruckend.", "Du bist ein Meister des Scheiterns.", "Sehr konsequent.", "Weiter so."], h:"Verliere 25 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:4 },
  { cond: (d) => d.closeLosses >= 40, i:"🌧️", t:"Tragik-Magnet V", d:["Du bist der personifizierte Pechvogel.", "Deine Niederlagen sind legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Verliere 40 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:5 },
  { cond: (d) => d.closeLosses >= 60, i:"🌧️", t:"Tragik-Magnet VI", d:["Du bist der Gott der Tragik.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Verliere 60 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:6 },
  { cond: (d) => d.closeLosses >= 85, i:"🌧️", t:"Tragik-Magnet VII", d:["Du bist die Tragik in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Verliere 85 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:7 },
  { cond: (d) => d.closeLosses >= 115, i:"🌧️", t:"Tragik-Magnet VIII", d:["Du hast die Grenzen der Tragik gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Verliere 115 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:8 },
  { cond: (d) => d.closeLosses >= 150, i:"🌧️", t:"Tragik-Magnet IX", d:["Du bist der unangefochtene König der Tragik.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Verliere 150 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:9 },
  { cond: (d) => d.closeLosses >= 200, i:"🌧️", t:"Tragik-Magnet X", d:["MAX-Tier: Du bist der personifizierte Herzschmerz.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Tragik.", "Legende."], h:"Verliere 200 knappe Spiele (du Rest=1)", g:"Tragik-Magnet", tier:10, max:true },
  ...
  { cond: (d) => d.vsWorstOpponentLosses >= 14, i:"🫥", t:"Haus-Gast III",d:["Du wohnst fast da.","Er hat deinen Schlüssel.","Das ist Dominanz (gegen dich).","Bittere Realität.","Zeit für Rache."], h:"Verliere 14× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:3 },
  { cond: (d) => d.vsWorstOpponentLosses >= 22, i:"🫥", t:"Haus-Gast IV", d:["Du bist der Lieblingsgegner.", "Deine Niederlagen sind ein Geschenk.", "Du bist ein Meister der Gastfreundschaft.", "Sehr großzügig.", "Weiter so."], h:"Verliere 22× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:4 },
  { cond: (d) => d.vsWorstOpponentLosses >= 33, i:"🫥", t:"Haus-Gast V", d:["Du bist der personifizierte Punktelieferant.", "Deine Niederlagen sind legendär.", "Du bist eine Inspiration.", "Absolut beeindruckend.", "Top-Leistung."], h:"Verliere 33× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:5 },
  { cond: (d) => d.vsWorstOpponentLosses >= 48, i:"🫥", t:"Haus-Gast VI", d:["Du bist der Gott der Gastfreundschaft.", "Deine Dominanz ist absolut.", "Du bist der unangefochtene Meister.", "Eine Klasse für sich.", "Weltklasse."], h:"Verliere 48× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:6 },
  { cond: (d) => d.vsWorstOpponentLosses >= 68, i:"🫥", t:"Haus-Gast VII", d:["Du bist der Haus-Gast in Person.", "Deine Macht ist unermesslich.", "Du bist eine Gottheit.", "Jenseits von Gut und Böse.", "Einfach nur wow."], h:"Verliere 68× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:7 },
  { cond: (d) => d.vsWorstOpponentLosses >= 95, i:"🫥", t:"Haus-Gast VIII", d:["Du hast die Grenzen der Gastfreundschaft gesprengt.", "Deine Leistung ist historisch.", "Du bist eine Legende für die Ewigkeit.", "Unfassbar.", "Absoluter Wahnsinn."], h:"Verliere 95× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:8 },
  { cond: (d) => d.vsWorstOpponentLosses >= 130, i:"🫥", t:"Haus-Gast IX", d:["Du bist der unangefochtene König der Haus-Gäste.", "Deine Leistung ist unmenschlich.", "Du bist der Maßstab.", "Ein Gott unter den Spielern.", "Unsterblich."], h:"Verliere 130× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:9 },
  { cond: (d) => d.vsWorstOpponentLosses >= 175, i:"🫥", t:"Haus-Gast X", d:["MAX-Tier: Du bist der personifizierte Stammgast.", "Deine Statistik ist ein Denkmal.", "Eine Leistung für die Ewigkeit.", "Der Endboss der Haus-Gäste.", "Legende."], h:"Verliere 175× gegen deinen schlimmsten Gegner", g:"Haus-Gast", tier:10, max:true },
];
...
window.processData = function(dataArray, todayStr) {
    ...
    const aggregates = { 
        ...
        playerBallWins: {}, teamResults: {}, ballSpez: {}, 
        matchupStats: {}, matchups: {}, meetings: {},
        eloTransfers: {}, sessionEloGains: {}
    };
    const initP = (n) => { 
        if (!pData[n]) pData[n] = { 
    ...
    dataArray.forEach(g => {
        ...
        winners.forEach(p => {
            ...
            if (breaker && !myTeam.includes(breaker) && (winners.includes(breaker) || losers.includes(breaker))) {
...
window.enrichStatsWithAchievements = function(baseStats, allMatches, configuredPlayers, dailyAchivs, isFullHistory = true) {
    ...
    allMatches.forEach(({ g, i: originalIndex }) => {
        ...
        players.forEach(p => {
            ...
            // Service thief logic
            const isMyTeamBreaker = isW ? winners.includes(breakerString) : losers.includes(breakerString);
            if (breakerString && !isMyTeamBreaker && (winners.includes(breakerString) || losers.includes(breakerString))) {
        ...
        const matchEloDelta = Math.round(totalMatchDeltaSum / (winners.length || 1));
        ...
        if (g.d && g.d.startsWith(todayStr)) {
            players.forEach(p => {
                ...
                if (winners.includes(p)) { // winners is already trimmed
                    ...
                    if (breakerString && winners.includes(breakerString)) simPData[p].todayBreakWins++;
                    if (rest === 1) simPData[p].todayClutchWins++;

                    // Today Service thief
                    const isMyTeamBreakerToday = winners.includes(breakerString);
                    if (breakerString && !isMyTeamBreakerToday && (winners.includes(breakerString) || losers.includes(breakerString))) {
...
window.renderBillardStats = function(stats, filterToday = false, onlyAchievements = false, rootEl = document, precalculatedCareerStats = null, precalculatedCareerStatsBeforeToday = null) { 
    ...
    if (filterToday) {
        ...
        if (todayHeaderFilterBox) {
            ...
            const unpaddedToday = actualTodayStr.split('.').map(p => parseInt(p, 10).toString()).join('.');
            const foundTodayStr = uniqueDates.find(d => d === actualTodayStr || d === unpaddedToday) || actualTodayStr;
    ...
    const normalizeDate = (s) => (s || "").split(',')[0].trim().split('.').map(p => parseInt(p, 10)).join('.');
  ...
  const borderStyle = isShame ? `border-left: 4px solid ${borderCol};` : 'border-left: none;';
    ...
    if (filterToday && mCard && mList && statsToday.length > 0) {
        ...
        const deltas = (precalculatedCareerStats && precalculatedCareerStats.matchDeltas) ? precalculatedCareerStats.matchDeltas : {};
        
        mList.innerHTML = [...statsToday].reverse().map((g, idx) => {
    ...
    if (labels.length > 0) {
        ...
        const thiefVals = labels.map(p => {
            const d = res.pData[p];
            const stolenWins = filterToday ? (d.todayStolenServiceWins || 0) : (d.stolenServiceWins || 0);
            const oppGames = filterToday ? (d.todayOpponentStartedGames || 0) : (d.opponentStartedGames || 0);
            const val = oppGames > 0 ? Math.round((stolenWins / oppGames) * 100) : 0;
            return { p, val, relevantGames: oppGames };
        });
        if (byId('stat-service-thief')) byId('stat-service-thief').innerText = getTopPlayerStr(thiefVals, 'val', "%", filterToday ? 1 : 5);

        // 9. ELO-Vampir (Wer hat wen am meisten geschröpft)
        const transfers = res.aggregates?.eloTransfers || {};
        let topVampireStr = "-";
        const sortedTransfers = Object.entries(transfers).sort((a,b) => b[1] - a[1]);
        ...
        if (filterToday) {
            ...
            let maxGain = 0; let recEntry = null;
        ...
        if (byId('stat-session-record')) byId('stat-session-record').innerText = sessionRecStr;
...
window.calculateStatsLocally = function(allMatches, players, todayStr = null) {
    ...
    const initP = (n) => {
        if (!pData[n]) pData[n] = { 
            ...
            todayGames: 0, todayWins: 0, todayMaxStreak: 0, todayClutchWins: 0, todayBreakWins: 0,
            todayBlackWinsCount: 0, todayKillerPoints: 0, todayRest: 0, todayAvgRest: 0,
            todayRegularWins: 0, todayFoul8Wins: 0, todayLostBy8BallError: 0,
            stolenServiceWins: 0, opponentStartedGames: 0, todayStolenServiceWins: 0, todayOpponentStartedGames: 0
        };
    };
